...
1. 从概念上来界定
	《简明牛津英语词典》(第9版)将密码学定义为"书写或求解代码的艺术"。——这个定义在历史上是准确的（直到20世纪晚期，密码学在很大程度上依然是一门艺术）
...
但在这里我们可以先给他做一个可能不那么准确的定义，方便我们后续的一个理解。
...
>**私钥设置**：通信双方预先共享某些秘密的信息，这种设置被称为私钥（或共享密钥/秘密密钥）设置。
>
